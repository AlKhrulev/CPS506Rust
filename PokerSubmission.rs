...
fn pairSuit(hand:[u32;5],pairVal:u32)->u32{
    let mut maxSuit = -1; //Potentially will return -1, so that's where the issue is
    for card in &hand{
